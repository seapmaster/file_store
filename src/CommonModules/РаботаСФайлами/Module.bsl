...
//
Функция ДобавитьФайлСДиска(ВладелецФайлов, ПутьКФайлуНаДиске, ИдентификаторФайла = Неопределено, КлиентХранилища = Неопределено) Экспорт
	...
	// Хранилище файлов
	Если Не ИдентификаторФайла = Неопределено Тогда
		СведенияОФайле.Вставить("ИдентификаторФайла", 	ИдентификаторФайла);
	КонецЕсли; // Если Не ИдентификаторФайла = Неопределено Тогда
	Если Не КлиентХранилища = Неопределено Тогда
		СведенияОФайле.Вставить("КлиентХранилища", 		КлиентХранилища);
	КонецЕсли; // Если Не КлиентХранилища = Неопределено Тогда
