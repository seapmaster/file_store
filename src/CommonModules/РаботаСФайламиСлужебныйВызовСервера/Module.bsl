...
Функция СоздатьФайл(Знач Владелец, Знач СведенияОФайле)
	...
	// Хранилище файлов
	Если СведенияОФайле.Свойство("ИдентификаторФайла") Тогда
		Файл.ИдентификаторФайла = СведенияОФайле.ИдентификаторФайла;
	КонецЕсли; // Если СведенияОФайле.Свойство("ИдентификаторФайла") Тогда
	Если СведенияОФайле.Свойство("КлиентХранилища") Тогда
		Файл.КлиентХранилища 	= СведенияОФайле.КлиентХранилища;
	КонецЕсли; // Если СведенияОФайле.Свойство("КлиентХранилища") Тогда
