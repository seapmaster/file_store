...
Функция НайтиФайл(ИдентификаторСтрока, КлиентХранилища) Экспорт
	...
	|	И Файлы.ИдентификаторФайла = &ИдентификаторФайла
	|	И Файлы.КлиентХранилища = &КлиентХранилища";
	Запрос.УстановитьПараметр("ИдентификаторФайла", ИдентификаторСтрока);
	Запрос.УстановитьПараметр("КлиентХранилища", 	КлиентХранилища);
